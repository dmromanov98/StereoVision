...
//        try {
//            BufferedImage imageL = ImageIO.
//            BufferedImage imageR = ImageIO.read((ImageInputStream) imageRight);
//
...
//        }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            imageLeft = new Image("file:testImages/imgL.jpg");
            imageRight = new Image("file:testImages/imgR.jpg");
